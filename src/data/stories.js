...
export const stories = [
  {
    ...
    location: '河南某村',
    title: '周一之约：剪刀下的温情',
    intro: '在河南的一个小村庄里，李佳欣女士受到李富贵故事的启发，决定将每周一设为"益剪日"，为村里的老人免费理发。她用一把剪刀，剪出了老人的精神，也剪出了社区的温暖。',
    ...
    sections: [
      {
        type: 'text-image',
        title: '缘起：学习李富贵的温暖行动',
        content: '在河南的一个小村庄里，李佳欣女士看到李富贵为老人做饭的故事，深受启发。她注意到村里的留守老人们常常因为行动不便，难以准备一日三餐。看着他们日渐消瘦的身影，她决定学习李富贵的做法。每周一剪完发后，她为老人们准备午餐，从最初为一位老人做饭，到后来服务整个村子的留守老人，这条路一走就是三年。',
